    ...
    <div id="login" class="wrapper">
        ...
        <div class="box">
            ...
            <form v-on:submit.prevent="onLogin()" v-if="countUser > 0">
                ...
                <div class="group">
                    <label>อีเมล์ :</label>
                    <input type="text" class="input" v-model="login.email" v-validate="'required'" name="email">
                    <span class="error">{{ errors.first('email') }}</span>
                </div>
    
                <div class="group">
                    <label>รหัสผ่าน :</label>
                    <input type="password" class="input" v-model="login.password" v-validate="'required'" name="password">
            ...
            <form v-on:submit.prevent="onRegister()" v-if="countUser == 0">
                ...
                <div class="group">
                    ...
                    <input type="text" class="input" v-model="register.name" v-validate="'required'" name="name">
                    <span class="error">
                        {{ errors.first('name') }}
                    </span>
                </div>
                ...
                <div class="group">
                    ...
                    <input type="text" class="input" v-model="register.email" v-validate="'required|email'" name="email">
                    <span class="error">
                        {{ errors.first('email') }}
                    </span>
                </div>
                ...
                <div class="group">
                    ...
                    <input type="password" class="input" v-model="register.password" v-validate="'required'" name="password">
                    <span class="error">
